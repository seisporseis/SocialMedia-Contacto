...
@section('contenido')
    ...
    <div class="flex justify-center">
        <div class="border border-light-purple rounded-lg shadow-xl w-full pl-20 md:w-6/12 lg:w-6/12 flex flex-col items-center md:flex-row">
            ...
            <div class=" lg:w-6/12 px-5 flex flex-col items-center md:justify-center md:items-start py-10 md:py-10">
    ...
    <h2 class="text-2xl text-center font-black">Tus snippets</h2>
